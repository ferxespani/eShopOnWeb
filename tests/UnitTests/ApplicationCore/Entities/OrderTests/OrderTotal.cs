...
public class OrderTotal
{
    ...
    public void IsZeroForNewOrder()
    {
        ...
        Assert.Equal(0, order.CalculateTotal());
    }
    ...
    public void IsCorrectGiven1Item()
    {
        ...
        Assert.Equal(_testUnitPrice, order.CalculateTotal());
    }
    ...
    public void IsCorrectGiven3Items()
    {
        ...
        Assert.Equal(builder.TestUnitPrice * builder.TestUnits, order.CalculateTotal());
    }
}
